...
#[inline]
pub unsafe fn vp8_read(r: *mut vp8_reader<'_>, prob: i32) -> i32 {
...
/// (each at prob = 128).
#[inline]
pub unsafe fn vp8_read_literal(r: *mut vp8_reader<'_>, bits: i32) -> i32 {
...
/// flip.
#[inline]
pub unsafe fn vp8_read_bit(r: *mut vp8_reader<'_>) -> i32 {
